...
` +
  ...
  `)
    ...
    function Xt(e) {
        return (
            e instanceof qe || (e && 'closed' in e && I(e.remove) && I(e.add) && I(e.unsubscribe))
        );
    }
    function So(e) {
        I(e) ? e() : e.unsubscribe();
    ...
    var Ho = (function (e) {
        ...
        return (
            ...
            (t.prototype.complete = function () {
                var r, o;
                (o = (r = this.destination) === null || r === void 0 ? void 0 : r.complete) ===
                    null ||
                    o === void 0 ||
                    o.call(r);
            }),
            (t.prototype._subscribe = function (r) {
                var o, n;
                return (n =
                    (o = this.source) === null || o === void 0 ? void 0 : o.subscribe(r)) !==
                    null && n !== void 0
                    ? n
                    : $r;
            }),
        ...
        return z([i, n]).pipe(
            m(([s, a]) => {
                ...
                return (
                    ...
                    {
                        active: s,
                        offset: { x: c - a.x + l.width / 2 - r / 2, y: p - a.y + l.height + 8 },
                    }
                );
            })
        );
            ...
            .pipe(
                ...
                b((a) =>
                    H(() => {
                        ...
                        return $(
                            [...o].reduce((p, [l, f]) => {
                                for (; c.length && o.get(c[c.length - 1]).tagName >= f.tagName; )
                                    c.pop();
                                let u = f.offsetTop;
            ...
            .pipe(
                ...
                m(([a, c]) =>
                    a.prev.length < c.prev.length
                        ? {
                              prev: c.prev.slice(Math.max(0, a.prev.length - 1), c.prev.length),
                              next: [],
                          }
                        : {
                              prev: c.prev.slice(-1),

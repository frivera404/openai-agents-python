...
const CodeBlock: React.FC<{ children: React.ReactNode }> = ({ children }) => (
    <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mt-2 overflow-x-auto">
        <code className="text-sm text-gray-800 dark:text-gray-200 font-mono">{children}</code>
    </pre>
);
    ...
    return (
        <div className="p-6 md:p-8 max-w-4xl mx-auto text-gray-800 dark:text-gray-200">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
                This guide explains how to set up and run the local backend server that securely
                proxies requests to the OpenAI Assistants API.
            </p>
            ...
            <section className="mb-10">
                ...
                <p>
                    Calling the OpenAI Assistants API directly from the browser would expose your
                    API key, which is a security risk. The backend server acts as a secure proxy:
                </p>
                <ul className="list-disc list-inside mt-2 space-y-1 pl-4">
                    <li>The frontend makes requests to our own backend.</li>
                    <li>
                        The backend, which runs in a secure environment, securely stores the API
                        key.
                    </li>
                    <li>
                        The backend forwards requests to the OpenAI Assistants API and returns the
            ...
            <section className="mb-10">
                ...
                <p>
                    You&apos;ll need Node.js installed. From your project root, install the
                    necessary server packages:
                </p>
                ...
                <h3 className="text-xl font-medium mt-6 mb-2">
                    Step 2.2: Create a{' '}
                    <code className="font-mono text-sm bg-gray-200 dark:bg-gray-700 p-1 rounded">
                        .env
                    </code>{' '}
                    File
                </h3>
...
VECTOR_STORE_ID="OPTIONAL_VECTOR_STORE_ID"`}</CodeBlock>
                <p className="mt-2 text-sm text-yellow-600 dark:text-yellow-400">
                    <strong>Important:</strong> Never commit the{' '}
                    <code className="font-mono text-sm">.env</code> file to version control. Add it
                    to your <code className="font-mono text-sm">.gitignore</code> file.
                </p>
            </section>
            ...
            <section className="mb-10">
                ...
                <p>
                    The application consists of two parts: the Vite frontend and the Express
                    backend. They need to run simultaneously. We recommend using a tool like{' '}
                    <code className="font-mono text-sm">concurrently</code>.
                </p>
                <h3 className="text-xl font-medium mt-4 mb-2">
                    Example <code className="font-mono text-sm">package.json</code> scripts:
                </h3>
                <CodeBlock>
                    {`"scripts": {
    "dev:frontend": "vite",
    ...
    "dev": "concurrently \\"npm:dev:frontend\\" \\"npm:dev:backend\\""
                ...
                <p className="mt-2">
                    The Vite dev server will automatically proxy API requests from the frontend (at{' '}
                    <code className="font-mono text-sm">/api</code>) to your backend server running
                    on port 3001.
                </p>
            </section>
            ...
            <section>
                ...
                <h3 className="text-xl font-medium mt-4 mb-2">
                    POST <code className="font-mono text-sm">/api/agent/launch</code>
                </h3>

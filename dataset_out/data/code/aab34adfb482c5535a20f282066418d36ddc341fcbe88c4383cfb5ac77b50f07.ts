...
export declare const SdkFlags: {
     ...
     */
    readonly OpenTelemetryInterceptorsTracesInboundSignals: SdkFlag;
    /**
     ...
     * @since Introduced in 1.13.2
     */
    readonly OpenTelemetryInterceptorsTracesLocalActivities: SdkFlag;
    /**
     ...
     * @since Introduced in 1.13.2
     */
    readonly OpenTelemetryInterceporsAvoidsExtraYields: SdkFlag;
};

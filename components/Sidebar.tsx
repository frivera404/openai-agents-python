...
const NavItem: React.FC<{
    ...
    <button
        onClick={onClick}
        className={`flex items-center w-full px-4 py-3 text-sm font-medium text-left transition-all duration-200 hover:translate-x-1 ${
            isActive
    ...
    return (
        <div className="w-64 bg-tech-gradient text-white flex-shrink-0 flex flex-col border-r border-gray-700 shadow-2xl">
            <div className="h-16 flex items-center px-4 border-b border-gray-600 bg-black/20">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-8 w-8 text-tech-accent animate-pulse"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                >
                ...
                <h1 className="text-xl font-bold ml-2 text-tech-accent">Agent Forge</h1>
            </div>

...
function pageProductProtect(){
  ...
  +'</div>'
  +'<div class="card" style="border-color:rgba(245,158,11,0.5);background:rgba(245,158,11,0.06);max-width:560px;margin:0 auto 24px;text-align:center;position:relative">'
